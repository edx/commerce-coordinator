...
- Integration rather than function: both the core and the plugins should strive to do *less*; plugins should simply communicate a specific external system and integrate with each other to bring the data and functionality of those systems together.

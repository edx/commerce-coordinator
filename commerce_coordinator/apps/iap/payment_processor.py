...
class IAPPaymentProcessor:
    ...
    def validate_iap(self, request_data, cart_id) -> dict:
        ...
        if payment_processor == 'android-iap':
            ...
            def validation_func():
                return self._validate_android(validator, purchase_token, course_run_key)
    ...
    def _validate_android(self, validator, purchase_token, course_run_key):
        return validator.validate(purchase_token, course_run_key)

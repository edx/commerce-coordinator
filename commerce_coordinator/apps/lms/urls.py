...
from commerce_coordinator.apps.lms.views import OrderDetailsRedirectView, PaymentPageRedirectView, RefundView
...
urlpatterns = [
    ...
    path('refund/', RefundView.as_view(), name='payment_page_redirect'),
]

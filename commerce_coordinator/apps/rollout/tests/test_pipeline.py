...
class TestGetActiveOrderManagementSystem(TestCase):
    ...
    def test_run_filter_with_bundle(
        self, MockCommercetoolsAPIClient, mock_is_program_redirection_to_ct_enabled
    ):
    ...
    @patch('commerce_coordinator.apps.rollout.pipeline.is_program_redirection_to_ct_enabled')
    @patch('commerce_coordinator.apps.rollout.pipeline.CommercetoolsAPIClient')
    def test_run_filter_with_bundle_flag_disabled(
        self, MockCommercetoolsAPIClient, mock_is_program_redirection_to_ct_enabled
    ):
    ...
    @patch('commerce_coordinator.apps.rollout.pipeline.is_program_redirection_to_ct_enabled')
    @patch('commerce_coordinator.apps.rollout.pipeline.CommercetoolsAPIClient')
    def test_run_filter_with_no_program_found(
        self, MockCommercetoolsAPIClient, mock_is_program_redirection_to_ct_enabled
    ):
        mock_is_program_redirection_to_ct_enabled.return_value = True
    ...
    @patch('commerce_coordinator.apps.rollout.pipeline.is_program_redirection_to_ct_enabled')
    @patch('commerce_coordinator.apps.rollout.pipeline.CommercetoolsAPIClient')
    def test_run_filter_with_ct_api_exception_for_bundle(
        self, MockCommercetoolsAPIClient, mock_is_program_redirection_to_ct_enabled
    ):
        mock_is_program_redirection_to_ct_enabled.return_value = True
        mock_client = MockCommercetoolsAPIClient.return_value
    ...
    @patch('commerce_coordinator.apps.rollout.pipeline.CommercetoolsAPIClient')
    def test_run_filter_with_course_run(
        self,
        MockCommercetoolsAPIClient,
    ...
    @patch('commerce_coordinator.apps.rollout.pipeline.is_redirect_to_commercetools_enabled_for_user')
    @patch('commerce_coordinator.apps.rollout.pipeline.CommercetoolsAPIClient')
    def test_run_filter_with_course_run_flag_disabled(
        self,
        MockCommercetoolsAPIClient,
        mock_is_redirect_to_commercetools_enabled_for_user,
    ):
    ...
    @patch('commerce_coordinator.apps.rollout.pipeline.is_program_redirection_to_ct_enabled')
    @patch('commerce_coordinator.apps.rollout.pipeline.CommercetoolsAPIClient')
    def test_run_filter_with_no_course_found(
        self,
        MockCommercetoolsAPIClient,
    ...
    @patch('commerce_coordinator.apps.rollout.pipeline.is_redirect_to_commercetools_enabled_for_user')
    @patch('commerce_coordinator.apps.rollout.pipeline.CommercetoolsAPIClient')
    def test_run_filter_with_ct_api_exception_for_course_run(
        self,
        MockCommercetoolsAPIClient,
        mock_is_redirect_to_commercetools_enabled_for_user,
    ):
    ...
    @patch('commerce_coordinator.apps.rollout.pipeline.CommercetoolsAPIClient')
    def test_run_filter_with_no_params(self, MockCommercetoolsAPIClient):
        request = MagicMock()
        request.query_params.getlist.return_value = []
